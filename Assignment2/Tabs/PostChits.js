/*
  ...
  This is the screen that allows the user to post chits from their accounts
*/
...
class PostChitsScreen extends Component {
  ...
  //Function to save and send drafts to the draft screen
  //Asyncu function which manages is the text field is empty and if the draft list is empty
  async draftManage() {
  ...
  //Async function for when a draft is added to the draft list
  ...
  //Async function for the first time a draft is saved
  async firstDraft() {
    try {
      const firstDrafts = [
        {
